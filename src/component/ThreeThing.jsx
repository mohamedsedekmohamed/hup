...
const TheeThing = ({navGo,like}) => {
  return (
    <div>
      <div className='w-full h-[48px]  mt-10 px-[26px] justify-between flex'>
          <div className='flex justify-center items-center gap-3 relative'> 
          <input placeholder='Search' className=' w-full md:w-[350px] h-[48px] border-2 border-two rounded-[8px] pl-10'/>
