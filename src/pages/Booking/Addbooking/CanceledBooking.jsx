...
const CanceledBooking = () => {
  const data = [
    {  BookingID: 'bk 2011', UserName: 'ahmed', Destination:"riyadh-jaddah",tripDate:"2025",Seats:"2",Status:"Canceled ", Action:"**" },
...
<div className=" mt-10 ml-5">
        ...
        <td className="w-[143px] h-[56px]  text-[16px] px-4 ">{item.BookingID}</td>
                    ...
                    <td className="w-[143px]  h-[56px]  text-[16px]  text-twelve  "><span className="bg-eight font-normal p-2 rounded-[8px]">{item.Status }</span></td>
